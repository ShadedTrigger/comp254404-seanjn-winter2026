...
public class SinglyLinkedList<E> implements Cloneable {
  ...
  // Swaps two nodes by reference.
  public void swapNodes(Node<E> node1, Node<E> node2) {
    if (node1 == node2) // Check if they are the same
      return;

    // Walk through the list to find the previous nodes
    Node<E> walk = head;
    Node<E> previousNode1 = null;
    Node<E> previousNode2 = null;
    while (walk != null && walk != node1) {
      previousNode1 = walk;
      walk = walk.getNext();
    }
    walk = head;
    while (walk != null && walk != node2) {
      previousNode2 = walk;
      walk = walk.getNext();
    }
  ...
  public static void main(String[] args)
  {
    ...
    myList.addFirst("Red");
    myList.addLast("Green");
    myList.addLast("Blue");

    System.out.println("Normal List: " + myList);

    myList.swapNodes(myList.head, myList.tail);

    System.out.println("Swapped List: " + myList);
  }
