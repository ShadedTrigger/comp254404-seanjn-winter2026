...
class PrefixAverage {
  ...
  public static void main(String[] args) {
    int n = 500;      // starting number of random values
    int trials = 10;
    ...
    for (int t=0; t < trials; t++) {
      double[] testArr = new double[n];
      for (int j = 0; j < n; j++) {
        testArr[j] = rand.nextDouble(); // get n number of random values to test
      }

      long startTime = System.currentTimeMillis();
      prefixAverage1(testArr);
